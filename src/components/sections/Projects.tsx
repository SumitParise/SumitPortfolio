    ...
    >
      <div className="flex flex-col items-center text-center mb-16">
        ...
        <p className="text-[#6B6B80] max-w-lg font-sans text-sm md:text-base">
          A showcase of recent client projects and open-source applications built with modern tools.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {PORTFOLIO.projects.map((project, idx) => (
          <article
            key={idx}
            className="reveal-item project-card p-6 md:p-8 rounded-2xl flex flex-col justify-between h-full group"
          >
            <div>
              {/* Header icons */}
              <div className="flex items-center justify-between mb-6">
                <div className="text-[#6C63FF] group-hover:text-[#00D4FF] transition-colors duration-300">
